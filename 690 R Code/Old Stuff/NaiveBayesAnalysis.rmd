...
NBPred2 <- train(selected_model, task2) #selected_model was defined above

#predictions_mlr2 <- as.data.frame(predict(NBPred2), mammMassesFinal2[,2:])
